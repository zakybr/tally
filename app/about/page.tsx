    ...
    <main>
      ...
      <article className="mx-auto max-w-[1440px] px-6 pb-28 pt-32 md:px-12 md:pt-40 lg:px-20">
        ...
        <header className="max-w-3xl">
          <div className="eyebrow mb-6">About Tally</div>
        ...
        >
          ...
          <Reveal delay={0.1}>
            <p className="mt-10 max-w-3xl border-l-2 border-amber pl-6 text-[0.9375rem] leading-[1.75] text-ink-2">
          ...
          <Reveal delay={0.15}>
            <div className="mt-14 divide-y divide-hairline border border-hairline">
        ...
        >
          ...
          <div className="mt-14 grid gap-14 md:grid-cols-2 md:gap-10 lg:gap-16">
            {directors.map((d, i) => (
              <Reveal key={d.name} delay={0.05 * (i + 1)}>
                ...
                <p className="mono-label mt-2 text-amber">{d.role}</p>
          ...
          <Reveal delay={0.2}>
            <p className="mt-14 max-w-2xl border-t border-hairline pt-8 text-[0.9375rem] leading-[1.7] text-ink-2">
        ...
        >
          <SectionHeader eyebrow="Where we sit" title="New Zealand primary industries." />
          <Reveal delay={0.1}>
            <p className="mt-8 max-w-3xl text-[0.9375rem] leading-[1.75] text-ink-2">
              ...
              <Link
                ...
                className="text-ink underline decoration-hairline underline-offset-4 transition-colors hover:text-amber"
              >
